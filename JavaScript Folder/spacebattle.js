...
------------------------------------------------------------------------  */
let uss;
const alienNames = ['Bob', 'John', 'Don', 'Larry', 'Tim', 'Betty', 'Karen', 'Lisa']
let alienShips = []
...
const startGame = () => {
    ...
    currentAlien = 0
    alienShips = []
    uss = new Ship('Black Pearl', 10, 5, .7)
...
// Initiate Game
startGame()
log('time to battle the 6 aliens, first is ' + alienShips[currentAlien].name + ' FIRE!')
